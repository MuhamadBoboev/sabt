        ...
        <div ref={ref} className={classes.info}>
            ...
            >
                <h1 className={classes.info_text}>
                    Мы – WeBrand.tj, digital-агентство, которое помогает бизнесу расти и развиваться в цифровой среде. Мы предлагаем полный спектр услуг по созданию и продвижению брендов: разработка сайтов, онлайн-эквайринг, дизайн и брендинг, SMM, анимация.
                </h1>
            </motion.div>
        </div>
    </Wrapper>
